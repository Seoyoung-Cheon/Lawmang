        ...
        <div className="left-layout bg-white rounded-3xl w-[900px] h-[820px] p-8 border border-gray-300 mt-[60px]">
          ...
          <div className="h-[600px]">
            ...
            <div className="mb-4">
              ...
              <div className="w-full p-3 border border-gray-300 rounded-xl text-lg bg-gray-50">
                {memo.title}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full h-[450px] p-6 border border-gray-300 rounded-2xl text-lg bg-gray-50 whitespace-pre-wrap overflow-y-auto">
                {memo.content}
              </div>
            </div>
