            ...
            list.append(
                {
                    ...
                    "CompliantCollection": result["CompliantCollection"],
                    "NonCompliantCollection": result["NonCompliantCollection"],
                    "NonCompliantPolicies": policylist,
                }
            )
        else:
            list.append(
...
def get_policyinfo(policyid: int, ally: CustomConnection):
    ...
    results = search_client.search(
        filter=f"PolicyId eq {policyid}", select="id,title,instruction,tags,severity"
    )
