@tool
def python_tool(
    query: str, search_result_list: list, ally: CustomConnection, language: str
) -> object:
    client = AzureOpenAI(
    ...
    if not search_result_list:
        ...
        - Add a note in the end that the inforamtion provided is not grounded on any Internal Company inforamtion or policy.
        ...
        try:
            openai_sentiment_response_post_text = openai_response.choices[
                0
            ].message.parsed
            response = json.loads(
